...
private:
	typedef ternary_tree<KeyT, KeyT, CompT, AllocT>    t_ternary_tree;
	typedef typename t_ternary_tree::iterator            tst_iterator;
	typedef typename t_ternary_tree::iterator::base_iter tst_iterator_base;
	typedef typename t_ternary_tree::const_iterator      tst_const_iterator;

	enum { invalid_index = size_type(-1) };

public:
	typedef typename t_ternary_tree::key_compare         key_compare;
	typedef typename t_ternary_tree::key_compare         value_compare;
	...
	enum constants { wildcard_char = t_ternary_tree::wildcard_char };

	//! Results from partial_match_search and hamming_search
	typedef search_results_list<t_ternary_tree, iterator>  t_search_results_list;
	...
	t_search_results_list create_search_results() const {
