#ifndef XPMDOC_GUI_XPM_H
#define XPMDOC_GUI_XPM_H
...
namespace xpm {
	...
	class Xpm : public QMainWindow
	{
		Q_OBJECT

	public:
		Xpm(QWidget *parent = 0);
		~Xpm();
		// for experiments
	...
	private:
		...
		private slots:
			...
			//open json
			void fileOpenTable();
			void fileOpenTemplate();
			void fileOpenReification();
			bool fileSave();
			// file save json
			bool fileSaveTable();
			bool fileSaveAs();
